...
class Custom_CE_Loss(tf.keras.losses.Loss):
    ...
    def lossF(self):        
        ...
        for i in range(1,limitLoop,1):
            ...
            dummyZ = zVal[:,:,i-1] + tau*(-2*tf.math.multiply((0.02+self.y_pred2[:,:,0]*0.01),zVal[:,:,i-1]) - tf.math.multiply(tf.math.square((0.02+0.01*self.y_pred2[:,:,0])),yVal[:,:,i-1])+tf.math.multiply(tf.math.square((0.02+0.01*self.y_pred2[:,:,0])),self.y_ins[:,:,i-1]))
            dummyIns = insVal[:,:,i-1] + tau*(-tf.math.multiply((0.142+0.005*self.y_pred2[:,:,1]),self.y_ins[:,:,i-1])+tf.math.multiply((0.09+0.01*self.y_pred2[:,:,2]),(tf.math.add(yVal[:,:,i-1],(12.7043+0.1*self.y_pred2[:,:,3])))))
            dummyX = xVal[:,:,i-1] + tau*((-1)*tf.math.multiply((0.05+0.005*self.y_pred2[:,:,4]),xVal[:,:,i-1])+tf.math.multiply((0.00038779+0.00005*self.y_pred2[:,:,5]),insVal[:,:,i-1])-tf.math.multiply(tf.math.multiply(tf.math.divide_no_nan((12.7043+0.1*self.y_pred2[:,:,3]),(0.142+0.005*self.y_pred2[:,:,1])),(0.09+0.01*self.y_pred2[:,:,2])),(0.00038779+0.00005*self.y_pred2[:,:,5])))
            dummyH = hVal[:,:,i-1]+tau*(-2*tf.math.multiply((0.4+0.05*self.y_pred2[:,:,6]),hVal[:,:,i-1])-tf.math.multiply(tf.math.square((0.4+0.05*self.y_pred2[:,:,6])),gVal[:,:,i-1])+tf.math.multiply((0.16+0.02*self.y_pred2[:,:,7]),self.y_meal[:,:,i-1]))
            dummyg = gVal[:,:,i-1] + tau*(hVal[:,:,i-1])
            dummyG1 = GVal[:,:,i-1] + tau*(-tf.math.multiply(xVal[:,:,i-1],GVal[:,:,i-1])-tf.math.multiply((0.0035+0.0005*self.y_pred2[:,:,8]),tf.math.subtract(GVal[:,:,i-1],(95+5*self.y_pred2[:,:,9])))+gVal[:,:,i-1])
